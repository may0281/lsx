...
<section class="banner-wrap">
            ...
            <div id="rev_slider" class="rev_slider"  data-version="5.0">
                <ul>
                    ...
                    <li data-transition="fade">
                        <!-- MAIN IMAGE -->
                        <img src="http://demo.themesuite.com/automotive/images/slide-show4.jpg" alt="">
   ...
   <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b> UNLOCK </b></p>
...
<div class="tp-caption customin customout start big_white"
    ...
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>THE POTENTIAL </b></p>
    <div class="data-code" align="center">
        <textarea rows="15">
<div class="tp-caption thin_red fade"
     data-x="300"
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b> business from your </b></p>
    <div class="data-code" align="center">
        <textarea rows="17">
<div class="tp-caption thin_white skewfromright"
     data-x="0"
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b> website</b></p>
    <div class="data-code" align="center">
        <textarea rows="15">
<div class="tp-caption cursive skewfromright"
     data-x="400"
