...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/img/favilogo.ico">
    ...
    <link href="<?php echo base_url();?>assets/css/ts.css" type="text/css" rel="stylesheet">
...
<section class="banner-wrap">
            ...
            <div id="rev_slider" class="rev_slider"  data-version="5.0">
                <ul>
                    ...
                    <li data-transition="fade">
                        ...
                        <!-- MAIN IMAGE -->
                        <img src="http://demo.themesuite.com/automotive/images/slide-show2.jpg"  alt="">
   ...
   <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>Time to invest in a website built to </b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption mediumlarge_light_white_center invest start"
     data-x="543"
     data-hoffset="0"
    ...
    Time to invest in a website built to
    ...
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>MOVE </b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption move mediumlarge_light_white_center fade"
     data-x="480"
     ...
     data-endeasing="Power1.easeIn"
     data-captionhidden="off"
     style="z-index: 6; letter-spacing: -3px;">
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>YOUR</b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption light_brown mediumlarge_light_white_center sfl"
     data-x="615"
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>INVENTORY </b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption dark_brown mediumlarge_light_white_center skewfromright "
     data-x="735"
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> TEXT Example : <b>FASTER </b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption faster mediumlarge_light_white_center skewfromright"
     data-x="960"
    ...
    <div style="clear: both"></div>
    <p STYLE="padding-top: 30px;padding-left: 60px;"> Image Example : <b><img src="http://demo.themesuite.com/automotive/images/brown_line.jpg" alt="underline"></b></p>
    <div class="data-code" align="center">
        <textarea rows="14">
<div class="tp-caption brown_line skewfromright"
     data-x="458"
    ...
    <img src="http://demo.themesuite.com/automotive/images/brown_line.jpg" alt="underline">
