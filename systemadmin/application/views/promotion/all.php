			...
			<div class="container">
				...
				<div class="crumbs">
					...
					<ul class="crumb-buttons">
						<li>
							<a href="<?php echo base_url();?>promotion/add"><i class="icon-plus"></i><span>Create Promotion</span></a>
						</li>
								...
								<table class="table table-striped table-bordered table-hover table-checkable datatable" data-display-length="30">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<img src='../images/promotion/<?php echo $r['CoverImage'];?>' width="50"></td>
...
<script type="text/javascript">
	function OnChangeCheckbox (checkbox) {
		var promotionid = checkbox.value;
		var base_url = "<?php echo base_url();?>";
		if (checkbox.checked) {
			window.location.href = base_url + "promotion/enable/1/" + promotionid;
		}
		else {
			window.location.href = base_url + "promotion/enable/0/" + promotionid;
		}
	}
</script>