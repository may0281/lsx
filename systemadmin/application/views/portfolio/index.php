        ...
        <div class="container">
            ...
            <div class="crumbs">
                ...
                <ul class="crumb-buttons">
                    <li>
                        <a href="<?php echo base_url();?>portfolio/create" ><i class="icon-plus"></i><span>Create Portfolio</span></a>
                    </li>
                        ...
                        <div class="widget-content">
                            <table class="table table-striped table-bordered table-hover table-checkable datatable" data-display-length="30">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src='../images/portfolio/<?php echo $r['img'];?>' width="150"></td>
...
<script type="text/javascript">
    function OnChangeCheckbox (checkbox) {
        ...
        if (checkbox.checked) {
            window.location.href = base_url + "portfolio/enable/1/" + productid;
        }
        else {
            window.location.href = base_url + "portfolio/enable/0/" + productid;
        }
    }
</script>