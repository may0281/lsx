			...
			<div class="container">
				...
				<div class="crumbs">
					...
					<ul class="crumb-buttons">
						<li>
							<a href="<?php echo base_url();?>blog/add"><i class="icon-plus"></i><span>Create Blog</span></a>
						</li>
								...
								<table class="table table-striped table-bordered table-hover table-checkable datatable" data-display-length="30">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<img src='../images/blog/<?php echo $r['CoverImage'];?>' width="50"></td>
											<td><?php echo $r['catEN'];?></td>
											<td><?php echo $r['NameTH'];?></td>
											<td><?php echo $r['NameEN'];?></td>

											<td data-hide="phone,tablet"><a href="<?php echo base_url(); ?>blog/edit/<?php echo $r['ID']; ?>" title="Edit blog">Edit </a></td>
											<td data-hide="phone,tablet"><a href="<?php echo base_url(); ?>blog/del/<?php echo $r['ID']; ?>" title="Edit blog">Del </a></td>
										</tr>
										<?php $i++; }?>
									</tbody>
								</table>
...
<script type="text/javascript">
	function OnChangeCheckbox (checkbox) {
		var blogid = checkbox.value;
		var base_url = "<?php echo base_url();?>";
		if (checkbox.checked) {
			window.location.href = base_url + "blog/enable/1/" + blogid;
		}
		else {
			window.location.href = base_url + "blog/enable/0/" + blogid;
		}
	}
</script>